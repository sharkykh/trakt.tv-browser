...
var defaultUa = "trakt.tv-browser/8.2.1-1 (https://github.com/sharkykh/trakt.tv-browser)";
var Trakt = /*#__PURE__*/function () {
  ...
  return _createClass(Trakt, [{
    ...
    value: function get_url() {
      this._authentication.state = randomBytes__default.default(6).toString('hex');
